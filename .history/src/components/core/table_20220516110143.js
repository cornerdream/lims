...
import { Table, Input, InputNumber, Popconfirm, Form, Typography , Tag, Radio, Space,Button} from 'antd';
          ...
          if(editable){
            ...
            return (
                <span>
                    ...
                    <Popconfirm title="Sure to delete?" onConfirm={cancelDelete}>
                        <a>Cancel</a>
                    </Popconfirm>
                </span> 
            )
